...
1. **Identify repo** — Determine which repo this is (dex, dex-studio, infradex) and its package name (`dataenginex`, `dex_studio`, `infradex`)
...
1. **Implement** — Follow existing patterns in the target module. Type hints everywhere. No print() — use structlog only.
