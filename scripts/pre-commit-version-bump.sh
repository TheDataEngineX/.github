...
#   - If same → bumps patch in pyproject.toml and re-stages it
#   - If different → user manually changed it; do nothing

set -euo pipefail

PYPROJECT="pyproject.toml"
# NOTE: .release-please-manifest.json is intentionally NOT touched here —
#       release-please owns that file; modifying it breaks its release detection.
